"""
Django settings for business_stack project.
...
SECRET_KEY = 'django-insecure-8kwman7(t2=5^wqsj1*cyfoq#4=tp1j09bw=8&=b*%$-x-d%7z'
...
ROOT_URLCONF = 'business_stack.urls'
...
WSGI_APPLICATION = 'business_stack.wsgi.application'
